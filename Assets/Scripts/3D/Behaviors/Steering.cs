...
public abstract class Steering : MonoBehaviour
{
    ...
    /// is useful in cases of objectAI which do not recalculate their forces
    ...
    /// instead of having the objectAI stop at a point until the next time that
    ...
    /// the objectAI, which will then blend all weighed forces from its steerings
